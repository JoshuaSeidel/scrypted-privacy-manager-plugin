  ...
  async getSettings(): Promise<Setting[]> {
    ...
    const privacySettings: Setting[] = [
      ...
      },
      {
        ...
        description: 'Privacy settings APPLY starting at this time (HH:MM). E.g., 22:00 to start blocking at 10 PM.',
        type: 'string',
        placeholder: '22:00',
      ...
      },
      {
        ...
        description: 'Privacy settings STOP at this time (HH:MM). E.g., 08:00 to allow recording at 8 AM.',
        type: 'string',
        placeholder: '08:00',
